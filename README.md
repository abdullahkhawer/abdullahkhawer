...
<p align="center">
  <a href="https://www.linkedin.com/in/abdullah-khawer">
    <img src="https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white" />
  </a>
  <a href="https://stackoverflow.com/users/11758843/abdullah-khawer">
    <img src="https://img.shields.io/badge/Stack_Overflow-FE7A16?style=for-the-badge&logo=stack-overflow&logoColor=white" />
  </a>
  <img src="https://komarev.com/ghpvc/?username=abdullahkhawer&color=blue&style=for-the-badge&label=PROFILE+VIEWS" />
</p>
...
I design and operate infrastructure that is **self-healing, highly available, secure, and cost-efficient**, built on AWS and modern DevOps practices.
...
<table>
  <tr>
    <td align="center"><b>⭐ 87</b><br/>GitHub Stars</td>
    <td align="center"><b>🍴 50</b><br/>GitHub Forks</td>
    <td align="center"><b>📦 16</b><br/>Repositories</td>
    <td align="center"><b>🏆 5,900+</b><br/>Stack Overflow Reputation<br/><small>🥇 5 &nbsp; 🥈 50 &nbsp; 🥉 96</small></td>
    <td align="center"><b>☁️ 2×</b><br/>AWS Certified<br/><small>• Developer Associate •<br/>• Cloud Practitioner •</small></td>
  </tr>
</table>
...
| Project | Description |
|---|---|
| [**GitLab CI Secrets with AWS SSM Parameter Store**](https://github.com/abdullahkhawer/gitlab-ci-secrets-aws-ssm-parameter-store) | Securely inject AWS SSM Parameter Store secrets into GitLab CI pipelines |
| [**DevOps Skills**](https://github.com/abdullahkhawer/devops-skills) | Reusable SKILL.md instruction files for AI agents: Claude Code, GitHub Copilot, Cursor, and more |
| [**Claude Code Bedrock Usage**](https://github.com/abdullahkhawer/claude-code-bedrock-usage) | CLI tool to monitor Claude Code token consumption, spend per model, and budget on AWS Bedrock |
| [**AI Local Chat Bot**](https://github.com/abdullahkhawer/ai-local-chat-bot) | Private, self-hosted AI assistant using n8n, Qdrant, and Ollama |
| [**MongoDB Cluster on AWS ECS**](https://github.com/abdullahkhawer/mongodb-cluster-on-aws-ecs) | Terraform module for a secure, HA, self-managed MongoDB cluster on ECS with monitoring |
| [**Kubernetes AWS EKS Auto Scaler**](https://github.com/abdullahkhawer/kubernetes-aws-eks-auto-scaler) | Automates scaling of EKS deployments, statefulsets, and cronjobs with state stored in Parameter Store |
| [**AWS Alerts**](https://github.com/abdullahkhawer/aws-alerts) | Slack-integrated alerting for AWS resource failures, errors, and terminations |
| [**Find and Report Secrets in Code**](https://github.com/abdullahkhawer/find-and-report-secrets-in-code) | Gitleaks-powered secret scanning with Confluence reporting and Slack alerts |
| [**AWS SSM Parameter Store Backup**](https://github.com/abdullahkhawer/aws-ssm-parameter-store-backup) | Terraform module to auto-backup all SSM parameters to S3 via Lambda |
| [**Simple Etcd Backup Restore**](https://github.com/abdullahkhawer/simple-etcd-backup-restore) | Bash-based etcd backup/restore with S3 upload and compression support |
| [**AWS Auto Terminate Idle EMR**](https://github.com/abdullahkhawer/aws-auto-terminate-idle-emr) | Lambda + CloudWatch solution to auto-terminate idle EMR clusters and reduce cost |
| [**Kubernetes Best Practices for Pods Resizing**](https://github.com/abdullahkhawer/kubernetes-best-practices-for-pods-resizing) | A reference guide for right-sizing Kubernetes pod and node resources |
| [**Simple Elasticsearch Cleaner**](https://github.com/abdullahkhawer/simple-elasticsearch-cleaner) | Python script to clean up Elasticsearch indices and data streams older than a set number of days |
| [**DevOps Helper Scripts**](https://github.com/abdullahkhawer/devops-helper-scripts) | A collection of helper scripts for common DevOps and AWS tasks |
| [**Vizion API Python Integration for AWS**](https://github.com/abdullahkhawer/vizion-api-python-integration-for-aws) | Flask-based Vizion API integration deployed on AWS Lambda and API Gateway via Serverless Framework |
| [**AK Encoder Decoder**](https://github.com/abdullahkhawer/ak-encoder-decoder) | Python tool for encoding and decoding texts and secrets, with executables for Windows and Linux |
...
<p align="center">
  <i>Open to interesting problems in platform engineering, DevOps, and cloud infrastructure.</i><br/>
  <a href="https://www.linkedin.com/in/abdullah-khawer">Let's connect on LinkedIn</a>
</p>
